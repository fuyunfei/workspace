    ...
    <Dialog open={showLoginDialog} onOpenChange={setShowLoginDialog}>
      <DialogContent className="sm:max-w-[800px] p-0 overflow-hidden" showCloseButton={false}>
        ...
        <div className="grid md:grid-cols-2 relative">
          {/* Left side - Form */}
          <form className="p-8 md:p-10 flex flex-col" onSubmit={handleSubmit}>
            <FieldGroup className="flex-1">
              <div className="flex flex-col items-center gap-2 text-center">
                <h1 className="text-2xl font-bold">Welcome back</h1>
                <p className="text-balance text-muted-foreground">
                  Login to your PageOn account
                </p>
              </div>
              <Field>
              ...
              <FieldDescription className="text-center text-xs">
                <a href="#" className="underline underline-offset-4 hover:text-primary" onClick={(e) => e.preventDefault()}>
                  Terms of Service
                </a>
                {" "}and{" "}
                <a href="#" className="underline underline-offset-4 hover:text-primary" onClick={(e) => e.preventDefault()}>
