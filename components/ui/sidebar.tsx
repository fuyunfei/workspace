    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          variant === "floating" || variant === "inset" ? "w-0" : "w-(--sidebar-width)",
      ...
      <div
        ...
        className={cn(
          ...
          variant === "floating"
            ? "left-0 transition-opacity duration-200 ease-linear opacity-100 group-data-[collapsible=offcanvas]:opacity-0 group-data-[collapsible=offcanvas]:pointer-events-none"
            : cn(
          ...
          // Adjust the padding for inset variant only.
          variant === "inset"
      ...
      >
        <div
          ...
          className="bg-sidebar group-data-[variant=floating]:border-sidebar-border flex h-full w-full flex-col group-data-[variant=inset]:rounded-lg group-data-[variant=inset]:border group-data-[variant=inset]:shadow-sm"
        >
          {children}
        </div>
      </div>
